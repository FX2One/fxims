# Generated by Django 4.1 on 2022-08-26 11:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('region', models.CharField(blank=True, db_column='Region', max_length=15, verbose_name='Region')),
                ...
                ('fax', models.CharField(blank=True, db_column='Fax', max_length=24, verbose_name='Fax')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ship_region', models.CharField(blank=True, db_column='ShipRegion', max_length=15, verbose_name='Ship region')),
                ...
                ('customer', models.ForeignKey(blank=True, db_column='CustomerID', null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory.customer')),
                ('employee', models.ForeignKey(blank=True, db_column='EmployeeID', null=True, on_delete=django.db.models.deletion.CASCADE, to='inventory.employee')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(db_column='Phone', max_length=24, verbose_name='Phone')),
                ('fax', models.CharField(blank=True, db_column='Fax', max_length=24, verbose_name='Fax')),
                ('homepage', models.TextField(blank=True, db_column='HomePage', verbose_name='HomePage')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='employee',
            name='territories',
            field=models.ManyToManyField(blank=True, db_table='EmployeeTerritories', to='inventory.territory', verbose_name='Territories'),
        ),
        migrations.AddField(
            model_name='customer',
            name='customer_customer_demo',
            field=models.ManyToManyField(blank=True, db_table='CustomerCustomerDemo', to='inventory.customerdemographics', verbose_name='Customer customer demo'),
        ),
    ]
