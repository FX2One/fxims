# Generated by Django 3.2.8 on 2022-09-26 13:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='employee',
            name='territories',
            field=models.ManyToManyField(blank=True, db_table='employee_territories', to='inventory.Territory', verbose_name='Territories'),
        ),
        migrations.AddField(
            model_name='customer',
            name='customer_customer_demo',
            field=models.ManyToManyField(blank=True, db_table='customer_customer_demo', to='inventory.CustomerDemographics', verbose_name='Customer customer demo'),
        ),
    ]
