# Generated by Django 3.2.8 on 2022-11-04 14:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_name', models.CharField(choices=[('N/C', 'Uncategorized'), ('BEV', 'Beverages'), ('CND', 'Condiments'), ('CNF', 'Confections'), ('DP', 'Dairy Products'), ('GC', 'Grains/Cereals'), ('MP', 'Meat/Poultry'), ('PRO', 'Produce'), ('SEA', 'Seafood')], db_column='CategoryName', db_index=True, help_text='format: required. Max_length: 100', max_length=100, verbose_name='Category name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, db_column='Photo', upload_to='employee', verbose_name='Photo')),
